...
data_as_html= dados.to_html(index=False, escape=False).encode("utf-8")
download_button = st.download_button(label="Download", data=data_as_html, file_name='chat-gpt4.html', mime='text/html')
